      ...
      <div className="grid gap-5 sm:gap-8 lg:grid-cols-2">
        {t.posts.map((post, index) => (
          <Link
            ...
            key={index}
            className="group p-5 sm:p-8 border border-border rounded-lg hover:border-muted-foreground/50 transition-all duration-500 hover:shadow-lg block cursor-pointer"
          >
